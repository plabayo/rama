...
impl<'a> Order<'a> {
    ...
    pub async fn download_certificate_no_checks(
        ...
        // .collect::<Result<Vec<X509Certificate<'_>>, _>>()
        // .context("failed to parse pem into X509Certificate")?;
    ...
    pub async fn download_certificate(&mut self, ctx: Context) -> Result<Vec<Pem>, ClientError> {
