...
Rama is a modular service framework distributed as a Rust crate at <https://crates.io/crates/rama/0.2.0-alpha.1>. You can add it to your project as follows:
...
* Crates Page: <https://crates.io/crates/rama/0.2.0-alpha.1>
