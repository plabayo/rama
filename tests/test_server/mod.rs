...
use rama::{error::BoxError, http::{client::HttpClient, Request}, service::{Context, Service}};
...
pub async fn recive_as_string(request: Request<String>) -> Result<String, BoxError>{
