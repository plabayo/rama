...
#[tokio::test]
#[ignore]
async fn test_http_mitm_relay_proxy() {
    utils::init_tracing();
    ...
    let runner = utils::ExampleRunner::interactive("http_mitm_relay_proxy_boring", Some("boring"));

    let proxy_address = ProxyAddress::try_from("http://john:secret@127.0.0.1:62049").unwrap();
