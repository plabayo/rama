...
pub(crate) enum Timer {
    ...
    MaxAckDelay = 8,
    /// Local limit on the entire TLS handshake, independent of packet activity.
    Handshake = 9,
    /// When to give up on the current probe of the server's preferred address
    PathProbe = 10,
}

impl Timer {
    pub(crate) const VALUES: [Self; 11] = [
        Self::LossDetection,
        Self::Idle,
        Self::Close,
        Self::KeyDiscard,
