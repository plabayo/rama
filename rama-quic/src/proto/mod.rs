...
pub use crate::proto::crypto::{ExportKeyingMaterialError, HandshakeSummary, ServerName};
...
pub(crate) mod fuzzing {
    ...
    pub use crate::proto::packet::{FixedLengthConnectionIdParser, PartialDecode};
