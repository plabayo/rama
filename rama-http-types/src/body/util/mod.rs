...
/// An extension trait for [`crate::body::Body`] adding various combinators and adapters
pub trait BodyExt: crate::body::StreamingBody {
    ...
    where
        Self: Sized,
        F: FnMut(crate::body::Frame<Self::Data>) -> crate::body::Frame<B>,
        B: bytes::Buf,
    {
        MapFrame::new(self, f)
    }
        ...
        Self: Sized,
    {
        combinators::Collect {
            body: self,
            collected: Some(super::util::Collected::default()),
        }
    }
    ...
    where
        Self: Sized,
        F: std::future::Future<Output = Option<Result<crate::header::HeaderMap, Self::Error>>>,
    {
...
impl<T: ?Sized> BodyExt for T where T: crate::body::StreamingBody {}
