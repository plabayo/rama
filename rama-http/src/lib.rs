...
pub use ::rama_http_types::{
    ...
    Response, Result as HttpResult, Scheme, StatusCode, StreamingBody, Uri, Version, conn,
    fingerprint, header, method, mime, opentelemetry, proto, request, response, sse, status, uri,
    version,
};
