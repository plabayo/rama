...
/// ## Examples
/// ```rust
/// use rama::proxy::pp::protocol::v2::{Addresses, Writer, WriteToHeader};
...
/// ## Examples
/// ```rust
/// use rama::proxy::pp::protocol::v2::{Addresses, AddressFamily, Builder, Command, IPv4, Protocol, PROTOCOL_PREFIX, Type, Version};
...
mod tests {
    use super::*;
    use crate::proxy::pp::protocol::v2::{
        AddressFamily, Command, IPv4, IPv6, Protocol, Type, Unix, Version,
    };
