...
use crate::{context::Extensions, stream::SocketInfo, Context};
...
impl<State, Body> crate::matcher::Matcher<State, Request<Body>> for PortMatcher {
    fn matches(
        &self,
...
impl<State, Socket> crate::matcher::Matcher<State, Socket> for PortMatcher
where
