...
fn parse_client_hello_from_bytes(
    ...
    let (rem, plain_text) = tls_parser::parse_tls_plaintext(raw_client_hello)
        .map_err(|err| OpaqueError::from_display(format!("parse raw client hello: {err:?}")))?;
    if !rem.is_empty() {
        return Err(OpaqueError::from_display("unexpected trailer data (rem>0)"));
    }
    if plain_text.hdr.record_type != tls_parser::TlsRecordType::Handshake {
        return Err(OpaqueError::from_display("unexpected TLS record type"));
    }
    if plain_text.msg.len() != 1 {
        return Err(OpaqueError::from_display(
            "one and only one handshake message expected",
        ));
    }

    let client_hello = match &plain_text.msg[0] {
...
mod tests {
    ...
    fn test_parse_raw_client_hello_pcap_dump_apple_itunes_bytes_success() {
        let client_hello = parse_client_hello_from_bytes(&[
            0x16, 0x03, 0x01, 0x02, 0x00, 0x01, 0x00, 0x01, 0xfc, 0x03, 0x03, 0x74, 0xbd, 0x2a,
            0x45, 0x51, 0x29, 0x95, 0x42, 0x61, 0x17, 0xab, 0x20, 0x8f, 0xf2, 0x30, 0xea, 0x72,
            0x0f, 0x2e, 0xcd, 0x73, 0xff, 0xcb, 0xbc, 0x89, 0x10, 0x46, 0xc8, 0xb7, 0x3c, 0x31,
            0xf0, 0x20, 0x25, 0xea, 0x68, 0xb2, 0x13, 0x62, 0xf7, 0x4b, 0x0f, 0x82, 0x57, 0xf6,
            0xe9, 0x41, 0xc5, 0x28, 0x74, 0xa9, 0xf4, 0x80, 0x73, 0x90, 0x4f, 0x85, 0xe7, 0xa7,
            0xaa, 0x84, 0x37, 0xe8, 0xdf, 0x97, 0x00, 0x2a, 0x7a, 0x7a, 0x13, 0x01, 0x13, 0x02,
            ...
            ,
            ...
            0x31, 0x00, 0x2d, 0x00, 0x02, 0x01, 0x01, 0x00, 0x2b, 0x00, 0x0b, 0x0a, 0xda, 0xda,
            0x03, 0x04, 0x03, 0x03, 0x03, 0x02, 0x03, 0x01, 0x00, 0x1b, 0x00, 0x03, 0x02, 0x00,
            0x01, 0xda, 0xda, 0x00, 0x01, 0x00, 0x00, 0x15, 0x00, 0xb9, 0x00, 0x00, 0x00, 0x00,
