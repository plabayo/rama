...
//! and on `127.0.0.1:40007` for the prometheus exportor.
//!
//! # Run the example
//!
//! ```sh
...
//! # Expected output
//!
//! The server will start and listen on `:40006` and `:40007`. You can use `curl`:
//!
//! ```sh
//! curl -v http://127.0.0.1:40006
//! curl -v http://127.0.0.1:40007/metrics
//! ```
//!
