...
//!
//! ```sh
//! cargo run -p rama-examples --bin http_sse_datastar_hello --features=http-full
//! ```
//!
//! Or if you want to see the dev-only hotreload in action:
//!
//! ```sh
//! RUST_LOG=debug cargo watch -x 'run -p rama-examples --bin http_sse_datastar_hello --features=http-full'
//! ```
//!
//! # Expected output
//!
