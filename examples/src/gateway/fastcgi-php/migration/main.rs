...
//!
//! This example uses Unix sockets and therefore only builds on
//! Unix-family targets (Linux, macOS, BSDs). On Windows it compiles to a
//! stub that simply prints a message and exits.
//!
//! # Run
//!
//! ```sh
//! ./examples/src/gateway/fastcgi-php/migration/run.sh
//! ```
//!
