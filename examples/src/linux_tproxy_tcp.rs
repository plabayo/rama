...
//!
//! ```sh
//! cargo build -p rama-examples --bin linux_tproxy_tcp --features=tcp,http && \
//!     sudo target/debug/linux_tproxy_tcp
//! ```
//!
...
//!
//! ```sh
//! sudo ./examples/src/linux_tproxy_tcp_setup.sh
//! ```
//!
//! and after testing:
//!
//! ```sh
//! sudo ./examples/src/linux_tproxy_tcp_cleanup.sh
//! ```
//!
...
//!   ./examples/src/linux_tproxy_tcp_setup.sh
//! ```
//!
...
//!
//! ```sh
//! cargo run -p rama-examples --bin linux_tproxy_tcp --features=tcp
//! sudo ./examples/src/linux_tproxy_tcp_setup.sh
