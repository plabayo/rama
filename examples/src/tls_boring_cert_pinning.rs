...
//!     cargo run -p rama-examples --bin tls_boring_dynamic_certs --features=http-full,boring
//! ```
//!
//! In another terminal:
//! ```sh
//! cargo run -p rama-examples --bin tls_boring_cert_pinning --features=http-full,boring -- \
