...
//!
//! ```sh
//! cargo run -p rama-examples --bin native_dns --features=dns -- localhost
//! cargo run -p rama-examples --bin native_dns --features=dns -- A localhost example.com
//! cargo run -p rama-examples --bin native_dns --features=dns -- TXT example.com
//! ```
