...
//! # Expected output
//!
//! The server will start and listen on `:40008`. You can use `curl` to interact with the service:
//!
//! ```sh
//! curl -v http://127.0.0.1:40008/limit
//! curl -v http://127.0.0.1:40008/limit/slow
//! ```
//!
...
//!
//! ```sh
//! curl -v http://127.0.0.1:40008/api/slow
//! ```
//!
