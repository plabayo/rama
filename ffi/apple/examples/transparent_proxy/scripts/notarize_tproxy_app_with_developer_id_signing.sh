...
APP_PATH="${RAMA_TPROXY_DIST_APP_PATH:-$DERIVED_DATA_PATH/Build/Products/Release/RamaTransparentProxyExampleContainer.app}"
NOTARY_DIR="${RAMA_TPROXY_NOTARY_DIR:-$DERIVED_DATA_PATH/notarization}"
ZIP_PATH="$NOTARY_DIR/RamaTransparentProxyExampleContainer.zip"
