...
xcodebuild   -project RamaTransparentProxyExample.xcodeproj   -scheme RamaTransparentProxyExampleContainer   -configuration Release   -derivedDataPath "$DERIVED_DATA_PATH"   RAMA_TPROXY_DEVELOPMENT_TEAM="$TEAM_ID"   RAMA_TPROXY_CONTAINER_SIGNING_IDENTITY="$CONTAINER_SIGNING_IDENTITY"   RAMA_TPROXY_EXTENSION_SIGNING_IDENTITY="$EXT_SIGNING_IDENTITY"   RAMA_TPROXY_CONTAINER_PROFILE_SPECIFIER="$CONTAINER_PROFILE_SPECIFIER"   RAMA_TPROXY_EXTENSION_PROFILE_SPECIFIER="$EXT_PROFILE_SPECIFIER"   RAMA_TPROXY_MARKETING_VERSION="$marketing_version"   RAMA_TPROXY_CURRENT_PROJECT_VERSION="$current_project_version"   clean build
