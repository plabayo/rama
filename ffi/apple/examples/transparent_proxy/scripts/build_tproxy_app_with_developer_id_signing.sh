...
XPCSERVICE_SIGNING_IDENTITY="${RAMA_TPROXY_XPCSERVICE_SIGNING_IDENTITY:-$HOST_SIGNING_IDENTITY}"
...
XPCSERVICE_PROFILE_SPECIFIER="${RAMA_TPROXY_XPCSERVICE_PROFILE_SPECIFIER:-Rama Transparent Proxy Example (XPC Service)}"
HOST_PROFILE_PATH="${RAMA_TPROXY_HOST_PROFILE_PATH:-}"
EXT_PROFILE_PATH="${RAMA_TPROXY_EXTENSION_PROFILE_PATH:-}"
XPCSERVICE_PROFILE_PATH="${RAMA_TPROXY_XPCSERVICE_PROFILE_PATH:-}"
...
install_profile_if_needed "$XPCSERVICE_PROFILE_PATH"

cd "$APP_DIR"
xcodegen generate --spec "$SPEC_PATH"
xcodebuild   -project RamaTransparentProxyExample.xcodeproj   -scheme RamaTransparentProxyExampleHost   -configuration Release   -derivedDataPath "$DERIVED_DATA_PATH"   RAMA_TPROXY_DEVELOPMENT_TEAM="$TEAM_ID"   RAMA_TPROXY_HOST_SIGNING_IDENTITY="$HOST_SIGNING_IDENTITY"   RAMA_TPROXY_EXTENSION_SIGNING_IDENTITY="$EXT_SIGNING_IDENTITY"   RAMA_TPROXY_XPCSERVICE_SIGNING_IDENTITY="$XPCSERVICE_SIGNING_IDENTITY"   RAMA_TPROXY_HOST_PROFILE_SPECIFIER="$HOST_PROFILE_SPECIFIER"   RAMA_TPROXY_EXTENSION_PROFILE_SPECIFIER="$EXT_PROFILE_SPECIFIER"   RAMA_TPROXY_XPCSERVICE_PROFILE_SPECIFIER="$XPCSERVICE_PROFILE_SPECIFIER"   RAMA_TPROXY_MARKETING_VERSION="$marketing_version"   RAMA_TPROXY_CURRENT_PROJECT_VERSION="$current_project_version"   clean build
