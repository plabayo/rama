...
impl ForwardedVersion {
    ...
    pub fn as_http(&self) -> Option<Version> {
        Some(match self.0 {
            VersionKind::Http09 => http::Version::HTTP_09,
            VersionKind::Http10 => http::Version::HTTP_10,
            VersionKind::Http11 => http::Version::HTTP_11,
            VersionKind::H2 => http::Version::HTTP_2,
            VersionKind::H3 => http::Version::HTTP_3,
        })
    }
}
