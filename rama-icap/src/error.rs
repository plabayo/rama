...
impl Error {
    ...
    fn description(&self) -> &str {
        match self.inner.kind {
            Kind::Parse(Parse::Method) => "invalid ICAP method parsed",
            Kind::Parse(Parse::Version) => "invalid ICAP version parsed",
            Kind::Parse(Parse::Uri) => "invalid URI",
            Kind::Parse(Parse::UriTooLong) => "URI too long",
            Kind::Parse(Parse::Header(Header::Token)) => "invalid ICAP header parsed",
            ...
            Kind::Parse(Parse::Status) => "invalid ICAP status-code parsed",
...
impl From<icaparse::Error> for Parse {
    fn from(err: icaparse::Error) -> Parse {
        match err {
            icaparse::Error::HeaderName
            | icaparse::Error::HeaderValue
            | icaparse::Error::NewLine
            | icaparse::Error::MissingEncapsulated
            | icaparse::Error::Token => Parse::Header(Header::Token),
            icaparse::Error::Status => Parse::Status,
            icaparse::Error::TooManyHeaders => Parse::TooLarge,
            icaparse::Error::Version => Parse::Version,
        }
    }
}
