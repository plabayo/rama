...
impl<T> Grpc<T> {
    ...
    /// # Example
    ///
    /// The most common way of using this is through a client generated by rama-grpc-build:
    ///
    /// ```rust
    /// use rama_grpc::transport::Channel;
    ...
    where
        T: GrpcService<Body>,
        T::ResponseBody: StreamingBody<Error: Into<BoxError>> + Send + 'static,
    ...
    where
        T: GrpcService<Body>,
        T::ResponseBody: StreamingBody + Send + 'static,
