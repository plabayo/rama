...
impl Mock<frame::Headers> {
        ...
        U::Error: fmt::Debug,
    {
        ...
        let frame = frame::Headers::new(id, pseudo, fields, None);
        Mock(frame)
    }
        ...
        S::Error: fmt::Debug,
    {
        ...
        let (id, _, fields) = self.into_parts();
        let frame = frame::Headers::new(id, frame::Pseudo::response(status), fields, None);
        Mock(frame)
    }
        ...
        V::Error: fmt::Debug,
    {
        ...
        fields.append(name, value.try_into().unwrap());
        let frame = frame::Headers::new(id, pseudo, fields, None);
        Mock(frame)
    }
    ...
    pub fn status(self, value: StatusCode) -> Self {
        ...
        Mock(frame::Headers::new(id, pseudo, fields, None))
    }
...
impl Mock<frame::PushPromise> {
        ...
        V::Error: fmt::Debug,
    {
        ...
        fields.append(key.try_into().unwrap(), value.try_into().unwrap());
        let frame = frame::PushPromise::new(id, promised, pseudo, fields);
        Mock(frame)
    }
