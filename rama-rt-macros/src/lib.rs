...
///
/// ```
/// #[rama::rt::main(flavor = "multi_thread", worker_threads = 10)]
/// # async fn main() {}
/// ```
///
...
///
/// ```
/// #[rama::rt::main(flavor = "current_thread")]
/// # async fn main() {}
/// ```
///
/// ## Function arguments:
...
/// ```
///
/// Equivalent code not using `#[rama::rt::main]`
///
/// ```rust
/// fn main() {
///     rama::rt::Builder::new_multi_thread()
///         .enable_all()
///         .build()
///         .unwrap()
///         .block_on(async {
...
/// ```rust
/// fn main() {
///     rama::rt::Builder::new_current_thread()
///         .enable_all()
///         .build()
///         .unwrap()
///         .block_on(async {
...
///
/// ```rust
/// #[rama::rt::main(flavor = "current_thread", start_paused = true)]
/// async fn main() {
///     println!("Hello world");
/// }
/// ```
...
///
/// fn main() {
///     rama1::rt::Builder::new_multi_thread()
///         .enable_all()
///         .build()
///         .unwrap()
///         .block_on(async {
...
///
/// ```no_run
/// #[rama::rt::test(flavor = "multi_thread", worker_threads = 1)]
/// async fn my_test() {
///     assert!(true);
/// }
/// ```
...
///
/// ```no_run
/// #[rama::rt::test(flavor = "multi_thread")]
/// async fn my_test() {
///     assert!(true);
/// }
/// ```
///
/// Equivalent code not using `#[rama::rt::test]`
///
/// ```no_run
/// #[test]
/// fn my_test() {
...
///
/// ```no_run
/// #[rama::rt::test(flavor ="multi_thread", worker_threads = 2)]
/// async fn my_test() {
///     assert!(true);
/// }
/// ```
...
///
/// ```no_run
/// #[rama::rt::test(start_paused = true)]
/// async fn my_test() {
///     assert!(true);
/// }
/// ```
...
/// ```text
/// The #[rama::rt::main] macro requires rt or rt-multi-thread.
/// ```
#[proc_macro_attribute]
...
/// Always fails with the error message below.
/// ```text
/// The #[rama::rt::test] macro requires rt or rt-multi-thread.
/// ```
#[proc_macro_attribute]
