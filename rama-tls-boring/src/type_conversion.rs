...
impl<'ssl> RamaTryFrom<rama_boring::ssl::ClientHello<'ssl>, RamaTlsRustlsCrateMarker>
    for ClientHello
{
...
macro_rules! try_from_mapping {
    (
        ...
        impl RamaTryFrom<rama_net::tls::$rama_ty, RamaTlsRustlsCrateMarker> for rama_boring::ssl::$boring_ty {
        ...
        impl RamaTryFrom<rama_boring::ssl::$boring_ty, RamaTlsRustlsCrateMarker> for rama_net::tls::$rama_ty {
...
impl RamaTryFrom<&rama_boring::x509::X509, RamaTlsRustlsCrateMarker>
...
impl RamaTryFrom<&rama_boring::stack::StackRef<rama_boring::x509::X509>, RamaTlsRustlsCrateMarker>
    for rama_net::tls::DataEncoding
{
    type Error = OpaqueError;
